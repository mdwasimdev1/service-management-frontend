...
export default function ServiceDetails() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "You can book easily via our online form.",
    },
    {
      q: "Do You Offer Evening And Weekends?",
      a: "Yes, we offer 24/7 support.",
    },
    {
      q: "Do You Have Only One Or Two Terms?",
      a: "We have flexible terms for all our clients.",
    },
    {
      q: "Do You Have To Provide Parking Materials?",
      a: "No, we bring our own equipment and materials.",
    },
    {
      q: "Do You Have Cleaning Agreements And Holidays?",
      a: "Yes, we have custom agreements based on your needs.",
    },
  ];
  ...
  const features = [
    {
      num: "01",
      title: "Ensuring Meets",
      desc: "We ensure all your cleaning goals are met efficiently with affordable price and quality assured as well.",
    },
    {
      num: "02",
      title: "24/7 Support",
    ...
    },
    {
      ...
      desc: "Always a wide variation of local options, which is little bit away, meets you extra time, and flexible.",
    },
    {
      num: "04",
    ...
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="relative w-full h-100 bg-stone-900 flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 text-center flex flex-col items-center">
          ...
          <div className="mt-2 text-stone-200 text-sm">
            3k+ People Used This Service
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1">
          ...
          <section className="mb-14">
            ...
            <p className="text-stone-600  leading-relaxed">
              Less time, required comprehensive genius info... Whatever requires
              comprehensive one inside hours, iterative in against type,
              tomorrow against mayor limited covering policies requires
              thorough. Less time, required comprehensive genius info...
              Whatever requires comprehensive one inside hours, iterative in
              against type, tomorrow against mayor limited covering policies
              requires thorough.
            </p>
            ...
            <div className="mt-5 relative">
              ...
              <div className="flex flex-col gap-5">
                {features.map((feat) => (
                  <div
                    key={feat.num}
                    className="flex flex-col sm:flex-row items-start gap-3 relative z-10"
                  >
                    <div className="w-8 h-8 rounded-full bg-amber-500 text-white flex items-center justify-center font-semibold text-base shrink-0 border-2 border-white shadow-sm">
                      {feat.num}
                    </div>
                    <div >
          ...
          {/* FAQ */}
          <section className="mb-14">
            <h3 className="text-2xl font-bold text-stone-900 mb-6">FAQ</h3>
              ...
              {[
                {
                  ...
                  desc: "Less time involved with inside concepts more based.",
                  active: true,
                },
                {
                  step: "Step 02",
                ...
                <div
                  key={s.step}
                  className="border border-stone-200 rounded-xl p-6 flex flex-col items-start relative"
                >
                  {/* Decorative line to next step for desktop */}
                  {s.step !== "Step 03" && (
                    <div className="hidden md:block absolute top-1/2 -right-3 w-6 h-px bg-stone-300"></div>
                  )}

                  <div
                    className={`px-4 py-1 rounded-full text-xs font-bold mb-4 ${s.active ? "bg-amber-400 text-stone-900" : "bg-stone-900 text-white"}`}
                  >
                    {s.step}
                  </div>
          ...
          {/* Review */}
          <section className="mb-14">
            <h3 className="text-2xl font-bold text-stone-900 mb-6">Review :</h3>
            <div className="border border-stone-200 rounded-xl p-8 flex flex-col md:flex-row items-center gap-8 md:gap-16 mb-8">
              <div className="text-center md:text-left flex flex-col items-center md:items-start">
                <div className="flex items-end gap-2 mb-2">
                  ...
                  <span className="text-xl text-stone-500 font-bold mb-1">
                    /5
                  </span>
                </div>
              ...
              <div className="flex-1 w-full max-w-sm flex flex-col gap-2">
                {[
                  ...
                  <div
                    key={bar.star}
                    className="flex items-center gap-3 text-sm font-semibold text-stone-600"
                  >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-stone-600 leading-relaxed">
                      ...
                      requires comprehensive one inside hours, iterative in
                      against type, tomorrow against mayor limited covering
                      policies requires thorough.
                    </p>
                  </div>
                </div>
              ))}
          ...
          <section className="mb-14">
            ...
            <p className="text-stone-600 mb-6 leading-relaxed">
              Less female covered hill carefully close minus attention. Turns
              assume no super segments, ran with ladies. Agreed infant format
              pair parameter. Untouched deploys minus massive onto works stands,
              faultless altogether core, format from segments steps.
            </p>
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  <div className="text-emerald-500 mt-1 shrink-0 bg-emerald-100 rounded-full p-0.5">
                    <BsArrowRightShort />
                  </div>
        ...
        <div className="w-full lg:w-100 shrink-0">
          <div className="sticky top-32 border border-stone-200 rounded-md p-3 sm:p-5 bg-white shadow-xl shadow-stone-200/40">
            <div className="text-stone-500 text-sm font-semibold mb-1">
              Start From
            </div>
            <div className="flex items-end gap-3 mb-2">
              ...
              <span className="text-stone-400 line-through text-sm mb-1 font-semibold">
                $530
              </span>
            </div>
            ...
            <form className="flex flex-col gap-3">
              <div>
                ...
                <input
                  type="text"
                  className="w-full border border-stone-200 rounded-lg px-4 py-2 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                />
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <div className="flex-1 relative">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="10 Aug 2023"
                      className="w-full border border-stone-200 rounded-lg pl-4 pr-10 py-2 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 text-sm"
                    />
              ...
              <div>
                <label className="block text-sm font-bold text-stone-700 mb-3 mt-2">
                  Select Services *
                </label>
              ...
              <CustomButton
                type="submit"
                className="w-full bg-amber-400 hover:bg-amber-500 text-stone-900 font-bold text-lg rounded-lg py-3.5 mt-4 transition-colors"
              >
                BOOK NOW
              </CustomButton>
            </form>
